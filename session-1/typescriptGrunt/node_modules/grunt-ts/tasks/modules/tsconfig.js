...
function getGlobs(taskOptions, targetOptions) {
    ...
    function getFlatCloneOf(array) {
        return __spreadArray([], _.flattenDeep(array), true);
    }
}
...
function addFilesToCompilationContext(applyTo, projectSpec) {
    ...
    if (projectSpec.exclude) {
        resolvedExclude.push.apply(resolvedExclude, (projectSpec.exclude.map(function (f) {
            ...
            try {
                ...
                verboseLogger("Warning: \"".concat(p, "\" was specified in tsconfig `exclude` property, but was not found on disk."));
            }
    ...
    if (resolvedInclude.length > 0 || resolvedExclude.length > 0) {
        ...
        var globsToResolve = __spreadArray(__spreadArray(__spreadArray([], resolvedInclude, true), resolvedExclude, true), resolvedExcludeFromGruntfile, true);
    ...
    var tsconfigCompilationContext = __spreadArray(__spreadArray([], expandedCompilationContext, true), resolvedFiles, true);
